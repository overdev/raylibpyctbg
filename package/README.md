...
![GitHub release (by tag)](https://img.shields.io/github/downloads/overdev/raylib-py/v5.5.0.post2/total?style=plastic)
...
![GitHub commits since tagged version](https://img.shields.io/github/commits-since/overdev/raylib-py/v5.0.0?style=plastic)
...
```
$ pip install path/to/raylib_py-5.5.0-py3-none-any.whl
```
